...
<body>
    ...
    <section class="service-area section-gap mt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 text-al" id="contact">
                    <div class="single-footer-widget newsletter">
                        <h6>رأيك يهمنا</h6>
                        <p>لو عندك سؤال عن المقال أو محتاج استشارة، تقدر تتواصل من صفحة الرئيسية.</p>
                        <a class="primary-btn header-btn text-uppercase mt-10" href="{{ route('home') }}#contact">تواصل معنا</a>
                    </div>
                </div>
            </div>
